...
- **Confusing `CdxLookup` and `CdxTypeaheadSearch`.** Lookup is for _form
  values_ (you must pick from suggestions); TypeaheadSearch is for _search
  navigation_ (you can submit free text, like the wiki search bar).
