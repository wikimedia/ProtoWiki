...
import MentionsModule from '../wikita-lite/modules/MentionsModule.vue'
import { MODULE_TITLES } from '../wikita-lite/routes'

definePage({
  meta: {
    title: 'Wikita-lite — Mentions',
    description: 'Articles mentioning your saved pages in Wikita-lite.',
  },
})
...
<template>
  <WikitaLiteShell :title="null">
    <MobileSubpageHeader :title="MODULE_TITLES.mentions" />
    <MentionsModule
      standalone
      :items="homeMentions"
